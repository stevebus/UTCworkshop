...
namespace StudentXXGateway
{
    public sealed class StartupTask : IBackgroundTask
    {
        ...
        private static string iotHubUri = "<youriothubname>.azure-devices.net";  // <iothubname>.azure-devices.net
        private string deviceId = "studentXX"; // replace XX with your studentID
        private static string deviceKey = "<<your device key>>";  // use your key, not mine!  :-)

        // classes related to serial communication
        static string serialDeviceName = @"<<your serial port name>>";
        // example serialDeviceName:   \\?\FTDIBUS#VID_0403+PID_6001+AL01GQQHA#0000#{86e0d1e0-8089-11d0-9ce4-08003e301f73}
